...
-- Tiempo de generación: 08-02-2017 a las 15:53:31
...
--
-- Estructura de tabla para la tabla `PatolSint`
--

CREATE TABLE IF NOT EXISTS `PatolSint` (
  `id_patol` int(2) NOT NULL,
  `id_sint` int(2) NOT NULL,
  `id_patolsint` int(2) NOT NULL,
  PRIMARY KEY (`id_patolsint`),
  KEY `id_patol` (`id_patol`),
  KEY `id_sint` (`id_sint`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Lo que causa la patologia';

--
-- Volcado de datos para la tabla `PatolSint`
--

INSERT INTO `PatolSint` (`id_patol`, `id_sint`, `id_patolsint`) VALUES
(1, 1, 1),
(1, 2, 2),
(1, 3, 3),
(1, 4, 4),
...
INSERT INTO `Sintomas` (`id_sint`, `des_sint`) VALUES
...
--
-- Filtros para la tabla `PatolSint`
--
ALTER TABLE `PatolSint`
  ADD CONSTRAINT `PatolSint_ibfk_1` FOREIGN KEY (`id_patol`) REFERENCES `Patologias` (`id_patol`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `PatolSint_ibfk_2` FOREIGN KEY (`id_sint`) REFERENCES `Sintomas` (`id_sint`) ON DELETE NO ACTION ON UPDATE CASCADE;
